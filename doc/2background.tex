...
affiliations are not used in this work because we cannot uniquely
...
\fixme{We will return to compare our results to those of Suominen and 
...
learning. The field has it's roots in statistics and engineering 
...
finding anomalies that don't fit in the group, such as analysing
