...
networks publications as nodes connected by citations as edges. In
...
Hybrid models combine both approaches. \fixme{Authors and their
...
b. analyysia''} \fixme{Mitkä olivat tulokset? Miten eroaa mun 
työstä? Vie myös ``Discussion'' -osioon.}

Our question here is: "How to automatically cluster Finnish
...
the clustering. \fixme{Selitä miten k-means liittyy tai jätä 
pois.} This is an unsolved problem. \fixme{citation}
Usually the 
...
and publisher assinged disciplines of the journal. We checked 
...
opininon for publications that could have been in more 
than one of our categories. For manually curated validation set 
with discipline assingment and justifications for
...
information system tai CS artifical intelligence.}
