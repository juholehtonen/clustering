...
Bibliometrics seeks to answer questions like ``Which research area
...
One of the earliest studies that is genereally considered
bibliometrics was Cole's and Eales' analysis to the anatomy 
literature in 1917 \cite{cole_history_1917}
\cite{bellis_bibliometrics_2009}. In this study they... \fixme{
Is this relevant? As an example of purposes of bibliometrics?}
...
author(s) or publisher or citations to other publications.
...
publications from years 1995-2011 using LDA... \cite{suominen_map_2016}
