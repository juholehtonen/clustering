...
\begin{figure}[htp]
  \begin{center}    
\includegraphics[width=10cm]{images/c-h-silh-index-plot-48000-4_500-800-hierarchical.png}
...
% We can see that the clusters 9, 19 and 31 have the shapes...
...
% We can see that the clusters 9, 19 and 31 have the shapes... in
% silhouette plot on Figure...
We see even from this narrow glimpse
that the clustering wasn't satisfactory.
% Kuvaile (kuten YL huomautti) jossain aiemmin tavoite paremmin,
% eli miksi tämä klusterointi ei ole tyydyttävä
