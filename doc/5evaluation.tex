...
the manually annotated data to see how good well our metrics 
reveal the our defined ground truth clustering. Then we clustered 
the actual data for one year with a range of $n$ values, the 
number of clusters, and calculated internal validation metrics for
