...
redundant repetion of the data and also to reduce the dimensions of 
...
record-feature matrix has the dimensionality of $m \times n$ where $m$ in 
...
% So essentially the labels could have been eg. 1, 2, 3.
